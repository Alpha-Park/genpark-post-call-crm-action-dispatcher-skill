# genpark-post-call-crm-action-dispatcher-skill
...
**genpark-post-call-crm-action-dispatcher-skill** is a deterministic, zero-dependency Python skill engineered for autonomous conversational voice agents, telephony IVR navigation, and real-time interruption arbitration.

> **Executive Capability**: Post-call structured summary & CRM webhook dispatcher (Synthflow / Bland)
...
result = client.dispatch_call_summary()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-post-call-crm-action-dispatcher-skill": {
      "command": "python",
      "args": ["/path/to/genpark-post-call-crm-action-dispatcher-skill/mcp_server.py"]
    }
  }
}
```
